      ...
      <div className="max-w-screen-xl mx-auto mt-3 px-2 sm:px-0">
        ...
        <div className="bg-white py-10 px-5 mt-1 flex justify-center items-center">
          <div className="block text-center">
            <h1 className="text-4xl">Welcome to WALLSS</h1>
        ...
        <div className="flex sm:justify-end justify-center">
          <a className="bg-purple-700 text-white px-2 cursor-pointer">MORE FEATURED DESKTOP WALLPAPERS</a>
        </div>
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 gap-2">
            {[...Array(12)].map((i, key) => {
                return (
                  <div key={key} className={``}>
                    <Image
                      className="bg-purple-300"
                      src={`https://images3.alphacoders.com/693/thumb-1920-693520.png`}
                      alt="Picture of the author"
                      width={500}
                      height={300}
                      quality={100}
          ...
          <div className="flex sm:justify-end justify-center">
            <a className="bg-purple-700 text-white px-2 cursor-pointer">MORE WALLPAPERS</a>
          </div>
